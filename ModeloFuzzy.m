...
%matriz_decisao = readtable(uigetfile('*.csv'));
...
% Classificacao dos criterios em beneficiais e nao-beneficiais atrav?s do input do
% usuario:
...
%usuario)
[icondata,iconcmap] = imread('check.png'); 
uiwait(msgbox('DEFINI??ES SALVAS COM SUCESSO',...
         'Sucesso','custom',icondata,iconcmap));
